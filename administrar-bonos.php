...
<html>
    ...
    <body class="skin-yellow">
        <div class="wrapper">
            ...
            <?php
              include('html/barraLateralAdmin-b.php');
            ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12" style="display: flex;  justify-content: center; padding-bottom: 50px" >
                            <div class="col-xs-6" >
                                ...
                                <a href="registrarTipoBonos.php" class="btn btn-info btn-block btn-flat">Crear nuevo tipo de bono</a>
                            </div>
                        </div>
                        <br>
                        <br>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="minas" class="table table-bordered table-hover">
                                        ...
                                        <?php echo $facade->cargarTipoBonos();?>
