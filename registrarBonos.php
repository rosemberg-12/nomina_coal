        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper inicio">
                ...
                <div class="login-box-body">
                  <form role="form" action="scripRegistrarBono.php" method="post">
                    <!-- text input -->

                      <!-- Aca se cargan los identificadores de cada tipo de puesto   -->

                      <div class="form-group" >
                          <label>Selecciona el tipo de bono</label>
                          <select class="form-control" id="tbono" name="tbono" required>
                              <option value>Seleccione uno</option>
                                <!-- cargar aca los tipos del descuento-->
                                <?php echo $facade->cargarComboTBonos();?>
                              </select>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Digite la un comentario respecto al bono" id="comentario" name="comentario" required >
                      </div>
