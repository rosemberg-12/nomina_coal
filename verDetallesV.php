...
<html>
    ...
    <body class="skin-yellow">
        <div class="wrapper">
            ...
            <?php
              include('html/barraLateralUserVolverLaboresV.php');
            ?>
                    ...
                    <div class="box" style="width: 70%; margin: 3% auto;">
                        ...
                        <div class="login-box-body">
                            <form role="form" action="scripRegistrarLabor.php" method="post">
                                ...
                                <div class="form-group" >
                                    <label>Lugar sobre el cual se desarrolló la labor</label>
                                    <select class="form-control" id="tipo_p" name="tipo_p" required disabled>

                                        <option value><?php echo $vector[4];?></option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group" >
                                    <label>Identificador del puesto de trabajo </label>
                                    <select class="form-control" id="identificador" name="identificador" required disabled>
                                        <option value><?php echo $vector[5];?></option>
