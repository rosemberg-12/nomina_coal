...
if (isset($_GET['estado'])){
    ...
    if(strcmp($_GET['estado'], "eliminados") == 0){
        $muestra= '<script type="text/javascript">alertify.success("Descuento eliminado exitosamente");</script>';
    }
    ...
    <body class="skin-yellow">
        ...
        <section class="content">
            ...
            <div class="login-logo titulo" style="color: #fff;">
                                    <a href="#">Descuentos realizados a <?php echo $_GET['nombre']; ?></a>
...
<!-- aca va la carga de las labores de la persona en especifico -->
                        <?php echo $facade->cargarDescuentoV($_GET['id'], $_GET['nombre'])?>
                    </tbody>
                    <tfoot>
                    <th>Fecha de registro(MM/DD/AA)</th>
                    <th>Tipo de descuento</th>
