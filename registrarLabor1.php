    ...
    ?>
            ...
            <div class="content-wrapper inicio">
                ...
                <div class="login-box-body">
                  <form role="form" action="scripRegistrarTipoLabor.php" method="post">
                    <!-- text input -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input type="number" step="any"  class="form-control" placeholder="Digite el precio por unidad de esta labor" id="ppu" name="ppu" required>
                      </div>
<br>
