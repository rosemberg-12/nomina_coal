            ...
            <div class="content-wrapper inicio">
                ...
                <section class="content">
                    ...
                    <div class="login-logo titulo" style="color: #fff;">
                                    <a href="#">Reasignar un empleado</a>
                              </div><!-- /.login-logo -->
                ...
                <div class="login-box-body">
                  <form role="form" action="scripReasignarEmpleado.php" method="post">
                    <!-- text input -->

                      <div class="form-group">
                          <label>Seleccione las minas donde sera reasignado</label>
                          <div class="col-xs-12">
                              <div class="box">
                                  ...
                                  <div class="box-body">
                                      ...
                                      <table id="minas" class="table table-bordered table-hover">
                                          ...
                                          <?php echo $facade->cargarMinasReasignar($_GET['id_empleado']);?>
