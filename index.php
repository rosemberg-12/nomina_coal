...
if( ( isset($_POST['documento']) && isset($_POST['password'])&& isset($_POST['tipo']) ) )
{
    ...
    $var=$facade->iniciarSesion($empleado,$_POST['tipo']);
    ...
    if(isset($_SESSION['id_mina'])){
        header('Location: indexUser.php?id='.$_SESSION['id_mina']);
    }
    else{
            ...
            <div class="content-wrapper inicio">
                ...
                <section class="content">
                    <!-- Incluir aqui el contenido-->
                        <div class="login-box">
                              <div class="login-logo" style="background-color: #f39c12; color: #fff;">
                                  <a href="#" style="color: #fff;"><b>Inicio </b>CoalNorth</a>
                              </div><!-- /.login-logo -->
