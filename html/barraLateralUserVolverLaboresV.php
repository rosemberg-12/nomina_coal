                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            <a href=<?php echo "verNominaV.php?id=".$_GET['id_emp']."&nombre=".$_GET['nombre']; ?>>
                                <i class="fa fa-dashboard"></i> <span>Volver a las labores</span>
                            </a>                            
                        </li>
                        <li class="treeview">
                            <a href="pick-trabajadorV.php">
                                <i class="fa fa-dashboard"></i> <span>Nómina</span>
                            </a>                            
                        </li>

                        <li class="treeview">
                            <a href="pick-minaV.php">
